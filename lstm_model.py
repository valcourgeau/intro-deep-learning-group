...
# From https://github.com/tgjeon/TensorFlow-Tutorials-for-Time-Series/blob/master/
    ...
    for i in range(len(data) - time_steps):
        if labels:
            try:
                ...
                rnn_df.append(data[i,:])
        else:
            #data_ = data[i:(i + time_steps),:]
            # rnn_df.append(data_)
            rnn_df.append(data[i:(i + time_steps),:])
...
def prepare_data(data, time_steps, labels=False, val_size=0.05, test_size=0.05):
    ...
    return {'train': rnn_data(df_train, time_steps, labels=labels),
